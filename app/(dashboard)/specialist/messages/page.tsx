...
function SpecialistMessagesPageContent() {
              ...
              {filteredConversations.length === 0 ? (
                ...
                filteredConversations.map((conversation) => (
                  <Link
                    ...
                    href={`/specialist/messages/${conversation.otherUser.id}${conversation.appointmentId ? `?appointment=${conversation.appointmentId}` : ""}`}
                    className="block"
                  >
                    <motion.div
